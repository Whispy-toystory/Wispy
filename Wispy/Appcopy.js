...
import PlayStartLoadingScreen from './screens/PlayStartLoadingScreen';
import ChatLoadingScreen from './screens/ChatLoadingScreen';
  ...
  return (
    <SafeAreaProvider>
      <NavigationContainer>
        <OnboardingProvider>
          <Stack.Navigator 
            initialRouteName="NameSpeakImage"
          ...
          >
            ...
            <Stack.Screen name="ChatLoading" component={ChatLoadingScreen} />
            <Stack.Screen name="PlayStartLoading" component={PlayStartLoadingScreen} />
          </Stack.Navigator>
        </OnboardingProvider>
      </NavigationContainer>
    </SafeAreaProvider>
